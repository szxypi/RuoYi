...
CREATE
ALIAS find_in_set AS 'int findInSet(String needle, String haystack) { if (needle == null || haystack == null) return 0; String[] parts = haystack.split(","); for (int i = 0; i < parts.length; i++) { if (needle.equals(parts[i].trim())) return i + 1; } return 0; }';
