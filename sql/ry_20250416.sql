...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'fdtemp科技', 0, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'admin', '15888888888', 'admin@fdtemp.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '管理员', '00', 'admin@fdtemp.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'test',  '测试员', '00', 'test@fdtemp.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', '项目主页', '0', '4', 'https://github.com', 'menuBlank', 'C', '0', '1', '', 'fa fa-location-arrow', 'admin', sysdate(), '', null, '项目主页地址');
-- 二级菜单
...
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'demoTask.withParams(\'demo\')', '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'demoTask.multipleParams(\'demo\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：系统已完成初始化，请及时修改默认密码', '2', '请登录后前往个人中心修改密码', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：系统将于每日凌晨 2:00-3:00 进行例行维护', '1', '维护期间系统暂停访问，请提前保存工作', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', 'fdtemp 管理系统介绍', '1', '<p>fdtemp 是基于 Spring Boot 3 的轻量级后台管理系统，提供用户权限、字典参数、定时任务、日志监控等通用能力。</p>', '0', 'admin', sysdate(), '', null, '管理员');
